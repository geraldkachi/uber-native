      ...
      <View>
        <View style={styles.view10}>
          <View style={styles.view11}>
            <Icon type="materialCommunity" name="clock-time-four" color={colors.white} size={18}/>
          </View>
          <View>
          ...
          <View>
            ...
            <View style={styles.view7}>
              ...
              <View style={styles.view8}>
                <Icon type="materialCommunity" name="plus-thick" color={colors.black} size={25}/>
              </View>
            </View>
          </View>
        </View>
      </View>
      <MapComponent {...{ userOrigin }} {...{ userDestination }} />
      <BottomSheet
        ref={bottomsheet1}
      ...
      >
        <BottomSheetFlatList
          ...
          ListHeaderComponent={
            <View style={styles.view10}>
              <View style={styles.view11}>
                <Icon type="materialCommunity" name="star" color={colors.white} size={20}/>
              </View>
              <View>
          ...
          ListFooterComponent={
            <View>
              <View style={styles.view10}>
                <View style={styles.view11}>
                  <Icon type="materialCommunity" name="map-marker" color={colors.white} size={20} />
                </View>
                <View>
              ...
              <View style={styles.view10}>
                <View style={styles.view11}>
                  <Icon type="materialCommunity" name="skip-next" color={colors.white} size={20}/>
                </View>
                <View>
